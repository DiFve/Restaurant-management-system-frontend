                      ...
                      <div className="relative w-auto my-6 mx-auto max-w-3xl">
                        ...
                        <div className="rounded-lg shadow-lg relative flex flex-col w-full bg-white">
                          ...
                          <div className="flex items-center justify-end p-6 border-t border-solid border-slate-200 rounded-b">
                            <button
                              className="text-black background-transparent font-bold px-6 py-2 text-sm mr-1 mb-1 ease-linear transition-all duration-150"
                              type="button"
                            ...
                            <button
                              className="bg-rose-500 text-white active:bg-rose-600 font-bold text-sm px-6 py-3 rounded shadow hover:shadow-lg mr-1 mb-1 ease-linear transition-all duration-150"
                              type="button"
                              onClick={() => setShowModal(false)}
                            >
                              Confirm
