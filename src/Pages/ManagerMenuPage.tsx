...
const ManagerMenuPage: React.FC = () => {
  let Menus = [
    ...
    { name: "กระเพราไข่ดาว", price: "0", pic: "https://sls-prod.api-onscene.com/partner_files/trueidintrend/6410/New%20Project.jpg" },
    { name: "kuy ต้ม", price: "0", pic: "https://upload.wikimedia.org/wikipedia/commons/a/ab/Shark_fin_stew.jpg" },
    { name: "กันชา", price: "0", pic: "http://www.disthai.com/images/content/original-1634718351789.jpg" },
